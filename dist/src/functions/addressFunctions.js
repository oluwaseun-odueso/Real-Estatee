...
exports.deletePropertyAddress = exports.updateAddressDetails = exports.getOnlyAddressDetails = exports.getAddressById = exports.addAddress = void 0;
...
;
async function deletePropertyAddress(id) {
    try {
        const deletedAddress = await address_1.Address.destroy({
            where: { id }
        });
