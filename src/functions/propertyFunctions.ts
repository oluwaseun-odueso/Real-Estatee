...
export async function getAllProperties(
  ...
  const manyProps = await Property.findAll({
    limit: query.limit,
...
export async function checkIfSellerHasProperty(
  id: number,
  seller_id: number
): Promise<boolean> {
  try {
...
export async function getFullPropertyDetails(
  property_id: number,
